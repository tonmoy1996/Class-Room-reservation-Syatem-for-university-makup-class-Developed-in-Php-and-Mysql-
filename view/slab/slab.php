    ...
    require_once '../adminop.php';
     ...
     ?>
        ...
        <div class="content-wrapper">
          <h3 class="page-heading mb-4">Schedule of Booked Lab Classes</h3>
          ...
          <div class="row mb-2">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  $sql = "SELECT booking.id,booking.faculty,booking.sub,booking.datee,booking.timee,booking.Room FROM booking LEFT JOIN classes on booking.course_id= classes.course_id where classes.type='Lab'  AND booking.semester='$csem'     ";
