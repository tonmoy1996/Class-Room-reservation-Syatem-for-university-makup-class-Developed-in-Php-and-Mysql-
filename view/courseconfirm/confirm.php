        ...
        <div class="content-wrapper" align='center'>
          ...
          <div class="row mb-2">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title mb-4">Verify Faculty's Alocated Courses</h5>
                    ...
                    <table class="table center-aligned-table">
                      ...
                      <tbody>
                        <tr class="">
                          ...
                          $sql = "SELECT * FROM course_alocation where semester='$csem'";
                          ...
                          while($row =$result->fetch_assoc())
                          {
                           ...
                           $output .= "<td><a href='status2.php?did=$row[id]'  class='btn btn-danger mr-2'>Delete</a></td>";
