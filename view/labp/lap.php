                          ...
                          <table class="table center-aligned-table">
                            ...
                            <tbody>
                              ...
                              <form method="post" action="">
                                          ...
                                          <tr><td>	 <input  onchange='this.form.submit();' type="radio" name="lab_t" value="8:00 AM" ></td><td><h4>08.00 am to 11.00 pm</h4></td></tr>
                                              <tr><td>      <input  onchange='this.form.submit();' type="radio" name="lab_t" value="11:00 AM"> </td><td><h4>11.00 am to 2.00 pm <h4></td></tr>
                                              <tr><td>     <input onchange='this.form.submit();' type="radio" name="lab_t" value="2:00 PM"> </td><td><h4>02.00 pm to 05.00 pm<h4></td></tr>
